...
class CnnNetwork(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(
            in_channels=64, out_channels=120, kernel_size=5, padding=1, stride=1)
    ...
    def forward(self, x):
        ...
        # Building Block 3
        # in_img = (7, 7), in_channels=64, out_channels=120, kernel_size=5, stride=1
        x = self.conv3(x)
        # out_img_size=(7,7), out_channel=120
        x = self.relu(x)
        # in_img_size=(7,7), out_channel=120, kernel_size=5, stride=1
        x = self.pool(x)
        # out_img_size=(3,3), out_channel=120
